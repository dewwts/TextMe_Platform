      ...
      <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5 min-h-screen">
        <div className="relative self-stretch px-4 py-16 overflow-hidden bg-blue-600 dark:bg-blue-700 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24">
          ...
          <div className="relative flex flex-col justify-between h-full max-w-lg mx-auto lg:mr-auto lg:max-w-md">
            <div className="flex-1">
              ...
              <p className="mt-4 text-base font-normal leading-7 text-blue-300 lg:text-lg lg:mt-6 lg:leading-8">Start connecting with friends and colleagues. Experience seamless communication with our intuitive messaging platform.</p>
            </div>
            ...
            <div className="mt-12 lg:mt-0">
              ...
              <blockquote className="mt-8">
                <p className="text-xl font-normal text-white">"Signing up was incredibly easy, and within minutes I was chatting with my team. Simple Chat lives up to its name!"</p>
              </blockquote>
              <div className="flex items-center mt-6">
                ...
                <div className="ml-4">
                  <p className="text-base font-semibold text-white">Michael Johnson</p>
                  <p className="text-sm font-normal text-gray-300">Team Lead, StartupHub</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="px-4 py-16 bg-white dark:bg-gray-900 sm:px-6 lg:col-span-3 lg:py-24 lg:px-8 xl:pl-12 flex items-center">
          <div className="max-w-lg mx-auto xl:max-w-xl w-full">
            <h2 className="text-3xl font-semibold tracking-tight text-gray-900 dark:text-white sm:text-4xl lg:text-5xl">Create your account</h2>
            ...
            <p className="mt-6 text-sm font-normal text-gray-500 dark:text-gray-400">
              ...
              <button onClick={onSwitchToLogin} className="text-sm font-semibold text-blue-600 dark:text-blue-400 hover:underline">
                Log in
              </button>
            </p>
          </div>
